...
I am grateful for comments, questions, bug reports, and requests to future editions of the book! If there's anything you'd like to add or share, please contact me via email at yarrr.book@gmail.com, or if you are familiar with GitHub, post an issue at  [https://github.com/ndphillips/ThePiratesGuideToR/issues](https://github.com/ndphillips/ThePiratesGuideToR/issues). Contributers will be added to the R pirate 
