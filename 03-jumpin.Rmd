...
```{r, fig.cap= "Despite what you might find at family friendly waterparks -- this is NOT how real pirate swimming lessons look.", fig.margin = TRUE, echo = FALSE, out.width = "50%", fig.align='center'}
...
Now let's make another pirateplot showing the relatinoship between sex and height using a different plotting theme and the `"pony"` color palette:
