...
```{r, fig.cap= "Traditionally, a pirate will steal a Beard Bauble from every pirate he beats in a game of Mario Kart. This pirate is is the Mario Kart champion of Missionsstrasse.", fig.margin = TRUE, echo = FALSE, out.width = "50%", fig.align='center'}
